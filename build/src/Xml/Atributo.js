...
class Atributo {
    ...
    getCstDotA(idPadre) {
        ...
        texto += Graficas_1.Graficas.getElement(this.idSent + 2, "IgualAtributo", this.idSent);
        texto += Graficas_1.Graficas.getElement(this.idSent + 3, "ValorAtributo", this.idSent);
        return texto;
    }
}
