...
*/
var xmlD = (function(){
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,8],$V1=[1,9],$V2=[1,14],$V3=[6,19],$V4=[2,5],$V5=[1,21],$V6=[2,6,13,19],$V7=[14,22,24],$V8=[2,24],$V9=[2,13],$Va=[2,13,16,19];
var parser = {trace: function trace () { },
yy: {},
symbols_: {"error":2,"XML":3,"TAG_CONFIGURACION":4,"LISTA_ETIQUETAS":5,"EOF":6,"ETIQUETA":7,"ListaEtiqueta":8,"TAG_APERTURA":9,"MenuEtiqueta":10,"TAG_UNICO":11,"DELIMITADOR":12,"AbreTagApertura":13,"CierreTagApertura":14,"TAG_CIERRE":15,"CadenaValores":16,"MENU_TAG_APERTURA":17,"LISTA_ATRIBUTOS":18,"AbreTagCierre":19,"CierreTagCierre":20,"MENU_TAG_UNICO":21,"CierreTagUnico":22,"AbreTagConf":23,"CierreTagConf":24,"ATRIBUTO":25,"ListaA":26,"NombreAtributo":27,"IgualAtributo":28,"ValorAtributo":29,"$accept":0,"$end":1},
terminals_: {2:"error",6:"EOF",13:"AbreTagApertura",14:"CierreTagApertura",16:"CadenaValores",19:"AbreTagCierre",20:"CierreTagCierre",22:"CierreTagUnico",23:"AbreTagConf",24:"CierreTagConf",27:"NombreAtributo",28:"IgualAtributo",29:"ValorAtributo"},
productions_: [0,[3,3],[3,2],[5,2],[8,2],[8,0],[7,2],[7,1],[7,2],[12,1],[12,1],[10,2],[10,2],[10,1],[9,2],[17,2],[17,1],[15,2],[11,2],[21,2],[21,1],[4,3],[18,2],[26,2],[26,0],[25,3]],
...
case 11:
           ...
           " MenuEtiqueta.val= LISTA_ETIQUETAS.val +TAG_CIERRE.val"      ) 
                ...
                this.$ = {
                nombreTagCierre: formatTagName($$[$0]),
                listaEtiqueta: $$[$0-1],
                cadena:''
        }
...
table: [{2:$V0,3:1,4:2,5:3,7:5,9:6,11:7,13:$V1,23:[1,4]},{1:[3]},{2:$V0,5:10,7:5,9:6,11:7,13:$V1},{6:[1,11]},{18:12,25:13,27:$V2},o($V3,$V4,{9:6,11:7,8:15,7:16,2:$V0,13:$V1}),{2:$V0,5:18,7:5,9:6,10:17,11:7,13:$V1,15:20,16:[1,19],19:$V5},o($V6,[2,7]),{12:22,13:[1,23],14:[1,24]},{14:[1,28],17:25,18:27,21:26,22:[1,29],25:13,27:$V2},{6:[1,30]},{1:[2,2]},{24:[1,31]},o($V7,$V8,{26:32,25:33,27:$V2}),{28:[1,34]},o($V3,[2,3]),o($V3,$V4,{9:6,11:7,7:16,8:35,2:$V0,13:$V1}),o($V6,[2,6]),{15:36,19:$V5},{15:37,19:$V5},o($V6,$V9),{20:[1,38]},o($V6,[2,8]),o($V6,[2,9]),o($V6,[2,10]),o($Va,[2,14]),o($V6,[2,18]),{14:[1,39],22:[1,40]},o($Va,[2,16]),o($V6,[2,20]),{1:[2,1]},o($V9,[2,21]),o($V7,[2,22]),o($V7,$V8,{25:33,26:41,27:$V2}),{29:[1,42]},o($V3,[2,4]),o($V6,[2,11]),o($V6,[2,12]),o($V6,[2,17]),o($Va,[2,15]),o($V6,[2,19]),o($V7,[2,23]),o([14,22,24,27],[2,25])],
defaultActions: {11:[2,2],30:[2,1]},
...
break;
case 11: this.begin("TagApertura"); return 13; 
break;
case 12:
break;
case 13: return 27; 
