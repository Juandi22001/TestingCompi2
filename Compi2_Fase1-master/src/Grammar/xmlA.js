...
*/
var xmlA = (function(){
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,8],$V1=[1,9],$V2=[1,15],$V3=[2,6,14,16],$V4=[1,19],$V5=[12,18,20,22],$V6=[2,10,14,16],$V7=[2,14];
var parser = {trace: function trace () { },
yy: {},
symbols_: {"error":2,"XML":3,"TAG_CONFIGURACION":4,"LISTA_ETIQUETAS":5,"EOF":6,"ETIQUETA":7,"TAG_APERTURA":8,"TAG_CIERRE":9,"CadenaValores":10,"TAG_UNICO":11,"CierreTagApertura":12,"DELIMITADOR":13,"AbreTagApertura":14,"LISTA_ATRIBUTOS":15,"AbreTagCierre":16,"CierreTagCierre":17,"CierreTagUnico":18,"AbreTagConf":19,"CierreTagConf":20,"ATRIBUTO":21,"NombreAtributo":22,"IgualAtributo":23,"ValorAtributo":24,"$accept":0,"$end":1},
terminals_: {2:"error",6:"EOF",10:"CadenaValores",12:"CierreTagApertura",14:"AbreTagApertura",16:"AbreTagCierre",17:"CierreTagCierre",18:"CierreTagUnico",19:"AbreTagConf",20:"CierreTagConf",22:"NombreAtributo",23:"IgualAtributo",24:"ValorAtributo"},
...
table: [{2:$V0,3:1,4:2,5:3,7:5,8:6,11:7,14:$V1,19:[1,4]},{1:[3]},{2:$V0,5:10,7:5,8:6,11:7,14:$V1},{2:$V0,6:[1,11],7:12,8:6,11:7,14:$V1},{15:13,21:14,22:$V2},o($V3,[2,4]),{2:$V0,5:16,7:5,8:6,9:18,10:[1,17],11:7,14:$V1,16:$V4},o($V3,[2,8]),{12:[1,20]},{12:[1,22],15:21,18:[1,23],21:14,22:$V2},{2:$V0,6:[1,24],7:12,8:6,11:7,14:$V1},{1:[2,2]},o($V3,[2,3]),{20:[1,25],21:26,22:$V2},o($V5,[2,19]),{23:[1,27]},{2:$V0,7:12,8:6,9:28,11:7,14:$V1,16:$V4},{9:29,16:$V4},o($V3,[2,7]),{17:[1,30]},o($V3,[2,9]),{12:[1,31],18:[1,32],21:26,22:$V2},o($V6,[2,13]),o($V3,[2,16]),{1:[2,1]},o($V7,[2,17]),o($V5,[2,18]),{24:[1,33]},o($V3,[2,5]),o($V3,[2,6]),o($V3,$V7),o($V6,[2,12]),o($V3,[2,15]),o($V5,[2,20])],
...
case 4:
break;
case 5: this.begin("TagApertura"); return 19; 
break;
case 6:
break;
case 7: return 22; 
...
case 9: return 24; 
break;
case 10: this.popState(); return 20; 
break;
case 11: this.begin("TagApertura"); return 14; 
break;
case 12:
break;
case 13: return 22; 
...
break;
case 18: this.begin("TagCierre"); return 16 
break;
case 19: this.popState(); return 17 
break;
case 20:
break;
case 21: return 10; 
...
case 22: return 6; 
break;
case 23: $$ = listaError.push(new ControlError(yy_.yytext, TipoSeleccion.ERROR_SINTACTICO, this._$.first_line, this._$.first_column,"XPathAscendente"))
break;
}
},
